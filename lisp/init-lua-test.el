;;; init-lua-test.el --- lua mode configuration
...
(define-derived-mode lua-test-mode lua-mode ())
(add-to-list 'auto-mode-alist '("\\test.lua$" . lua-test-mode))
;;(add-to-list 'interpreter-mode-alist '("lua" . lua-test-mode))
;;(provide 'lua-test-mode)
...
;; is activated.
(add-hook 'lua-test-mode-hook 'my-lua-setup)

(provide 'init-lua-test)
;;; init-lua-test.el ends here
